...
agenda = [{"nome": "Jonas", "telefone": "85 98888-3333", "categoria": "Amigos"}
]
index = None
...
def adicionarContato():
    # Limpando a tabela
    # get_children -> Retorna as linha da tabela
    for linha in tabela.get_children():
        tabela.delete(linha)
